...
#define PROJECT_EMAIL "cscdlfirebase@gmail.com"
#define PROJECT_PASSWORD "Ineffable!
...
void setup(){
  ...
  Firebase.RTDB.setBool(&fbdo, "mouse_detected", true) 
}
